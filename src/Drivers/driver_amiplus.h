...
private:
  float get_voltage_at_phase_v(uint8_t phase, std::vector<unsigned char> &telegram) {
    float ret_val{};
    uint32_t usage = 0;
    size_t i = 11;
  ...
  float get_total_energy_consumption_kwh(std::vector<unsigned char> &telegram) {
    float ret_val{};
    uint32_t usage = 0;
    size_t i = 11;
  ...
  float get_current_power_consumption_kw(std::vector<unsigned char> &telegram) {
    float ret_val{};
    uint32_t usage = 0;
    size_t i = 11;
  ...
  float get_total_energy_production_kwh(std::vector<unsigned char> &telegram) {
    float ret_val{};
    uint32_t usage = 0;
    size_t i = 11;
  ...
  float get_current_power_production_kw(std::vector<unsigned char> &telegram) {
    float ret_val{};
    uint32_t usage = 0;
    size_t i = 11;
